...
|------|----------|-----|----------|----------|------|
| Hello（Keep-Alive） | 1000 | 26528 | 37.32ms | 58.66ms | 4 线程 |
| Hello（Keep-Alive） | 5000 | 23650 | 201.70ms | 275.01ms | 8 线程 |
| 短连接 | 1000 | 2738 | 259.75ms | 668.50ms | `Connection: close` |
| 路径参数 :id | 1000 | 23488 | 42.10ms | 65.52ms | 4 线程 |
| POST echo | 1000 | 22566 | 43.77ms | 66.62ms | 4 线程 |

> 测试环境：vivo V2338A（aarch64 / arm64-v8a，8 核）、内存 14Gi、Android（kernel 5.15.178）、Clang 21.1.8、Termux 环境，Release `-O2`。客户端 wrk 与服务端同机运行。
